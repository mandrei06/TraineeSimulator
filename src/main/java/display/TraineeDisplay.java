...
public class TraineeDisplay {
    ...
    public static void tranieeDisplay(int openCenters, int bootCamp , int techCenter, int trainingHub,  int fullCenters, int numberOfTrainees, int list){

        System.out.println("Total centres opened: " + openCenters +
